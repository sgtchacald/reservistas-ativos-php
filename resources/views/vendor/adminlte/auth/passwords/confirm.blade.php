...
@section('body')
    <div class="lockscreen-wrapper">
        ...
        <div class="lockscreen-name">
            {{ isset(Auth::user()->usunomecompleto) ? Auth::user()->usunomecompleto : Auth::user()->usuemail }}
        </div>
        ...
        <div class="lockscreen-item">
            @if(config('adminlte.usermenu_image'))
                <div class="lockscreen-image">
                    <img src="{{ Auth::user()->adminlte_image() }}" alt="{{ Auth::user()->usunomecompleto }}">
                </div>
            @endif
            ...
            <form method="POST" action="{{ route('password.confirm') }}"
                ...
                <div class="input-group">
                    <input id="ususenha" type="password" name="ususenha" autocomplete="current-password"
                           class="form-control @error('ususenha') is-invalid @enderror"
