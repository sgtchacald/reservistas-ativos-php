					...
					<div class="col-sm-1">
						<div class="form-group required">
							...
							<input 	type="text"
									...
									maxlength="100"
									value="{{old('id', $nivelEstudo[0]->id)}}" readonly>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="form-group required">
							...
							<input 	type="text"
									...
									maxlength="100"
									value="{{old('nome', $nivelEstudo[0]->nome)}}">
						</div>
					</div>
						...
						<div class="form-group required">
							...
							<select name="indStatus" id="indStatus" class="form-control @error('indStatus') is-invalid @enderror readyOnly" readonly>
								...
								@foreach ((\App\Dominios\IndStatus::getDominio()) as $key => $value)
									<option @if(old('indStatus', $nivelEstudo[0]->indstatus)==$key) {{'selected="selected"'}} @endif value="{{$key}}">
										{{$value}}
									</option>
								@endforeach
							</select>
